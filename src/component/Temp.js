...
callAPI(req) {
    fetch("http://localhost:9000/testAPI",req)
        .then(res => res.json())
   ...
   // let api = this.state.apiResponse
    ...
    // <CodeMirror value={this.state.code} onChange={this.updateCode.bind(this)} options={options} className="codedit"/>
	  ...
	  return(
        ...
        <Container fluid="true" style={{backgroundColor:"#e0e0e0"}}>
         <Row>
           <Col><h2 ><Badge color="primary">Learn With Me</Badge></h2></Col>
           <Col>
    ...
    <UncontrolledDropdown>
      ...
      <DropdownMenu>
       ...
       <Row>
         ...
         <Col xs="6" style={{overflowY:"scroll"}}> <h3>QUESTION DESCRIPTION</h3><hr /></Col>
